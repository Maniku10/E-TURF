...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="index.html">E-<span>TURF</span></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="/userviewbooking" class="nav-link">View</a></li>
                    <li class="nav-item"><a href="/userprofile" class="nav-link">My profile</a></li>
                    <li class="nav-item"><a href="/usergallery" class="nav-link">Gallery</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                    <h2 class="footer-heading"><a href="#" class="logo">E - TURF</a></h2>
